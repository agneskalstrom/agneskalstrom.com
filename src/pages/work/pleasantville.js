  ...
  return (
    <>
      <ProjectIntro
        ...
        desc="Whilst looking for the mysterious Alex in a bizarre town called Pleasantville, the main character finds themselves in a state between being awake and dreaming, and has to find a set of clues to solve the riddle and proceed on their quest. This level is part of a bigger world which, in turn, is part of the game Escape from Hyper Island, developed by the students of the front-end development program at Hyper Island."
